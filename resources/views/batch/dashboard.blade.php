                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-body d-flex flex-column p-0" style="height: 100%;">
                            ...
                            <div class="d-flex justify-content-between p-3" style="height: 50%;">
                                ...
                                <!-- Total Request Card -->
                                <div class="card border border-primary text-center mx-2" style="flex: 1;">
                                    <div class="card-body">
                                        <a href="#" class="text-dark text-hover-primary fw-bolder"
                                            style="font-size: 1.2rem;">Total Request</a><br>
                                        <span class="text-gray-400 fw-bold">Oct 8 - Oct 26, 22</span>
                                        <div class="fw-bolder fs-3 text-primary" style="font-size: 1.75rem;">24,500</div>
                                    </div>
                                </div>

                                <!-- Approved Request Card -->
                                <div class="card border border-success text-center mx-2" style="flex: 1;">
                                    <div class="card-body">
                                        <a href="#" class="text-dark text-hover-primary fw-bolder"
                                            style="font-size: 1.2rem;">Approved Request</a><br>
                                        <span class="text-gray-400 fw-bold">Oct 8 - Oct 26, 22</span>
                                        <div class="fw-bolder fs-3 text-success" style="font-size: 1.75rem;">24,500</div>
                                    </div>
                                </div>

                                <!-- Failed Request Card -->
                                <div class="card border border-danger text-center mx-2" style="flex: 1;">
                                    <div class="card-body">
                                        <a href="#" class="text-dark text-hover-primary fw-bolder"
                                            style="font-size: 1.2rem;">Failed Request</a><br>
                                        <span class="text-gray-400 fw-bold">Oct 8 - Oct 26, 22</span>
                                        <div class="fw-bolder fs-3 text-danger" style="font-size: 1.75rem;">24,500</div>
                                    </div>
                                </div>
                            </div>
                        </div>
